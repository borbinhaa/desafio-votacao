...
public record OpenVotingSessionRequest(
        @Schema(description = "How long the session stays open; defaults to 1 minute", example = "5", minimum = "1", maximum = "1440")
                @Nullable @Min(1) @Max(MAX_DURATION_MINUTES) Integer durationMinutes) {
